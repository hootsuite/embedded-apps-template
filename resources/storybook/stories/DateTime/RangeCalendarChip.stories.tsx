...
import type { DateRange, RangeCalendarChipProps } from '@ds/comp-date-picker';

import { RangeCalendarChip } from 'hootsuite-bento';
...
const meta = {
  title: 'Bento/DateTime/RangeCalendarChip',
  component: RangeCalendarChip,
...
} satisfies Meta<typeof RangeCalendarChip>;

export default meta;
type Story = StoryObj<typeof meta>;

export const Base: Story = {
  render: function Render(args: RangeCalendarChipProps) {
